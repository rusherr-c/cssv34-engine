...
//-----------------------------------------------------------------------------
// Purpose: Create junction: platform --> core
// Output : bool
//-----------------------------------------------------------------------------
bool CreateCoreJunction() {
#ifndef NO_CORE_JUNCTION
	char moduleName[MAX_PATH];
	char core[4096], platform[4096];
	...
	sprintf(core, "%s\\core", pRootDir);
	sprintf(platform, "%s\\platform", pRootDir);

	CreateSymbolicLinkA(core, platform, SYMBOLIC_LINK_FLAG_DIRECTORY); // create core junction to platform
	return true;
#else
	return true;
#endif
